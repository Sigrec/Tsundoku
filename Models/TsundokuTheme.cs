...
namespace Tsundoku.Models
{
    public class TsundokuTheme : ICloneable, IDisposable, IEquatable<TsundokuTheme?>
    {
        ...
        Color.FromRgb(223, 213, 158).ToUint32(), //5
        Color.FromRgb(223, 213, 158).ToUint32(), 
        Color.FromArgb((byte)Math.Floor(0.6 * 255), 18, 23, 29).ToUint32(), 
        Color.FromArgb((byte)Math.Floor(0.7 * 255), 223, 213, 158).ToUint32(), 
        Color.FromRgb(223, 213, 158).ToUint32(), 
        Color.FromRgb(18, 23, 29).ToUint32(), //10
        Color.FromRgb(223, 213, 158).ToUint32(), 
        Color.FromRgb(18, 23, 29).ToUint32(), 
        Color.FromRgb(223, 213, 158).ToUint32(), 
        Color.FromRgb(18, 23, 29).ToUint32(), 
        Color.FromArgb((byte)Math.Floor(0.99 * 255), 32, 35, 45).ToUint32(), //15
        Color.FromRgb(32, 35, 45).ToUint32(), 
        Color.FromArgb((byte)Math.Floor(0.95 * 255), 223, 213, 158).ToUint32(), 
        Color.FromRgb(223, 213, 158).ToUint32(), 
