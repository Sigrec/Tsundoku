...
namespace Tsundoku.Views
{
    public partial class AddNewSeriesWindow : Window
    {
        ...
        public async void OnButtonClicked(object sender, RoutedEventArgs args)
        {
            ...
            bool validSeries = await AddNewSeriesVM.GetSeriesDataAsync(TitleBox.Text.Trim(), (MangaButton.IsChecked == true) ? "MANGA" : "NOVEL", CurVolNum, MaxVolNum, AddNewSeriesViewModel.ConvertSelectedLangList(AddNewSeriesVM.SelectedAdditionalLanguages));
