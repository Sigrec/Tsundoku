...
namespace Tsundoku.Views
{
    public partial class PriceAnalysisWindow : Window
    {
        ...
        // {
        //     AddDataPoints(PriceAnalysisViewModel.testData, ((DataGrid)((Button)sender).GetLogicalSiblings().ElementAt(2)));
        // }

        // public void AddDataPoints(ObservableCollection<string[]> masterData, DataGrid AnalysisDataGrid)
        // {
