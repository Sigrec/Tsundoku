...
namespace Tsundoku.Models
{
    public class Constants
    {
        ...
        public static readonly List<string> ADVANCED_SEARCH_FILTERS = new List<string> {"Rating==", "Rating>=", "Rating<=", "Status==Finished", "Status==Ongoing", "Status==Cancelled", "Status==Hiatus", "Format==Manga", "Format==Novel", "Demographic==Shounen", "Demographic==Shoujo", "Demographic==Seinen", "Demographic==Josei", "Notes==", "Cost==", "Cost>=", "Cost<=", "Read==", "Read>=", "Read<=", "CurVolumes==", "CurVolumes>=", "CurVolumes<=", "MaxVolumes==", "MaxVolumes>=", "MaxVolumes<=", "Series==Complete", "Series==InComplete", "Favorite==True", "Favorite==False"}.OrderBy(x => x).ToList();
