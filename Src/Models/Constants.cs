...
namespace Tsundoku.Models
{
    public class Constants
    {
        ...
        public static readonly string[] ADVANCED_SEARCH_FILTERS = ["Rating=", "Rating>=", "Rating<=", "Status=Finished", "Status=Ongoing", "Status=Cancelled", "Status=Hiatus", "Format=Manga", "Format=Novel", "Demographic=Shounen", "Demographic=Shoujo", "Demographic=Seinen", "Demographic=Josei", "Notes=''", "Staff=''", "Cost=", "Cost>=", "Cost<=", "Read=", "Read>=", "Read<=", "CurVolumes=", "CurVolumes>=", "CurVolumes<=", "MaxVolumes=", "MaxVolumes>=", "MaxVolumes<=", "Series=Complete", "Series=InComplete"];
